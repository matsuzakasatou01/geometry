...
部分脚本的使用方法可以查看我的这两篇专栏  [专栏一](https://b23.tv/ITY6Ylx)  [专栏二](https://b23.tv/D5qhCk8)。  
...
执行模板得出的随机效果以十万秒（1天3小时46分40秒）为周期。（这个模板的执行时间大约为2.6~2.7秒（大于1秒），为了解决行宽度相同的行上下句过渡时因跨秒产生随机数不同的问题而设定这个周期。）
